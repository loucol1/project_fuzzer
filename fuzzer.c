...
void change_mode(int *count_crash, int *count_other_msg, char* argument){
    ...
    first = 0x80;
    for(int index=1;index<7 && flag!=1;index++){// test a non ascii character for all index of mode[index]
...
void change_gid(int *count_crash, int *count_other_msg, char* argument){
    ...
    for(int index = 0;index<7 && flag!=1; index++){ //test all octal values in all positions
...
void change_size(int *count_crash, int *count_other_msg, char* argument){
    ...
    int new_gid;
    for(int index = 0;index<11 && flag!=1; index++){//test all octal values in all positions
...
void change_linkname(int *count_crash, int *count_other_msg, char* argument){
    ...
    first = 0x80;
    for(int index=1;index<99 && flag!=1;index++){ //test a non ascii character for all index of linkname[index]
...
void change_magic(int *count_crash, int *count_other_msg, char* argument){
    ...
    first = 0x80;
    for(int index=1;index<5 && flag!=1;index++){ //test a non ascii character for all index of magic[index]
...
void change_uname(int *count_crash, int *count_other_msg, char* argument){
    ...
    first = 0x80;
    for(int index=1;index<31 && flag!=1;index++){ //test a non ascii character for all index of uname[index]
